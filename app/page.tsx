...
const menuItems: MenuItem[] = [
  ...
  { id: "iced-coffee-regular", name: "Regular Iced Coffee", category: "Other Drinks", price: 3.75 },
  { id: "iced-coffee-large", name: "Large Iced Coffee", category: "Other Drinks", price: 4.25 },
  ...
  { id: "frappe-mocha", name: "16 oz Mocha Frappe", category: "Frappes", price: 6.75 },
  { id: "frappe-caramel", name: "16 oz Caramel Frappe", category: "Frappes", price: 6.75 },
  { id: "frappe-vanilla", name: "16 oz Vanilla Frappe", category: "Frappes", price: 6.75 },
];
...
export default function Page() {
  ...
  const [selectedOptions, setSelectedOptions] = useState<
    Record<string, { milk: string; flavor: string; notes: string }>
  >({});
